  ...
  public final Symbol CUP$Parser$do_action_part00000000(
    ...
    throws Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		List<Node> l = (List<Node>)((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		Node e = (Node)((Symbol) CUP$Parser$stack.peek()).value;
		...
		Node e = (Node)((Symbol) CUP$Parser$stack.peek()).value;
          ...
          case 4: // paramlistOpt ::= paramlist 
            {
              List<Node> RESULT =null;
		List<Node> l = (List<Node>)((Symbol) CUP$Parser$stack.peek()).value;
		...
		Node e = (Node)((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
          ...
          case 7: // expr ::= IDENTIFIER LPAREN paramlistOpt RPAREN 
            {
              Node RESULT =null;
		String m = (String)((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-3)).value;
		List<Node> p = (List<Node>)((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		...
		String v = (String)((Symbol) CUP$Parser$stack.peek()).value;
          ...
          case 9: // expr ::= FLOAT 
            {
              Node RESULT =null;
		Double f = (Double)((Symbol) CUP$Parser$stack.peek()).value;
		...
		Node r = (Node)((Symbol) CUP$Parser$stack.peek()).value;

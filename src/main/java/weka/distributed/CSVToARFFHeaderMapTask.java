...
public class CSVToARFFHeaderMapTask implements OptionHandler, Serializable {
  ...
  private boolean treatUnparsableNumericValuesAsMissingaluesAsMissing;

  public boolean getTreatUnparsableNumericValuesAsMissing() {
    return treatUnparsableNumericValuesAsMissingaluesAsMissing;
  }

  public void setTreatUnparsableNumericValuesAsMissing(boolean treatUnparsableNumericValuesAsMissingaluesAsMissing) {
    this.treatUnparsableNumericValuesAsMissingaluesAsMissing = treatUnparsableNumericValuesAsMissingaluesAsMissing;
  }
